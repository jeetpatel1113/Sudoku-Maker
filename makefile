...
#   -O3 turns on optimization level 3 (maximizes speed)
...
g++ -O3 -std=c++17 -Wall -Wextra -Werror -Wfatal-errors -Wno-sign-compare -Wnon-virtual-dtor -g a1main.cpp -o sudoku